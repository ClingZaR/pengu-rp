...
return {
    ...
    garages = {
        ...
        -- PenguRP: garages for the two gangs that shipped without one (El Burro Heights / Little Seoul)
        vagos = {
            label = 'Vagos',
            vehicleType = VehicleType.CAR,
            groups = 'vagos',
            accessPoints = {
                {
                    coords = vec4(898.98, -2570.0, 28.3, 0),
                    spawn = vec4(902.5, -2565.6, 28.3, 174.0),
                }
            },
        },
        triads = {
            ...
            accessPoints = {
                {
                    coords = vec4(-560.0, -560.0, 33.5, 0),
                    spawn = vec4(-565.2, -565.4, 33.5, 268.0),
                }
            },
        },
