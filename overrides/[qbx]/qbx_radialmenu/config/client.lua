...
-- PenguRP: shared LEO radial items for police, bcso and sasp (jobItems is keyed by job name).
-- Removed Reset House Lock (qb-houses) and Revoke Drivers License (police:client:SeizeDriverLicense),
-- neither event has a handler on this server.
local leoItems = {
    {
        id = 'emergencyButton',
        icon = 'bell',
...
return {
    ...
    menuItems = {
        {
            ...
            label = 'Citizen',
            items = {
                { -- PenguRP: qb-phone is not on this server, open the npwd phone instead
                    id = 'openphone',
                    icon = 'mobile-screen',
                    label = 'Phone',
                    onSelect = function()
                ...
                },
                {
                    ...
                    items = {
                        ...
                        -- PenguRP: removed Take Hostage, police:client:TakeHostage has no handler on this server
                    },
                },
            },
        },
        {
            ...
            label = 'General',
            items = {
                { -- PenguRP: qbx_vehiclekeys /givekeys (nearest player, or vehicle occupants)
                    id = 'givekeys',
                    icon = 'key',
                    label = 'Give Keys',
                    onSelect = function()
                ...
                { -- PenguRP: scully_emotemenu client export
                    id = 'emotes',
                    icon = 'face-smile',
                    label = 'Emotes',
                    onSelect = function()
    ...
    jobItems = {
        police = leoItems, -- PenguRP
        bcso = leoItems, -- PenguRP
        sasp = leoItems, -- PenguRP
        ambulance = {
            {
                id = 'statusCheck',
                icon = 'heart-pulse',
