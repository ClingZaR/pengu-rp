-- PenguRP: vendored copy of qbx_core/shared/locale.lua (qb-core compatible Locale class).
-- PenguRP: replaces the original '@qb-core/shared/locale.lua' manifest reference so this
-- PenguRP: resource does not depend on qb-core packfiles existing (Qbox provides qb-core via bridge).
Locale = {}
