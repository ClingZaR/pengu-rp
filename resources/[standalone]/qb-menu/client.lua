-- PenguRP: the Qbox qb-core bridge does not expose a GetShared export, and the
-- PenguRP: qb-inventory nui image path this table feeds does not exist on this
-- PenguRP: server (ox_inventory). An empty table skips the icon rewrite safely;
-- PenguRP: FontAwesome icons and full URLs still work as normal.
local sharedItems = {} -- PenguRP: was exports['qb-core']:GetShared('Items')
